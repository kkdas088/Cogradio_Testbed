...
class cs_mac(object):
    ...
    def phy_rx_callback(self, ok, payload):
        ...
        """
        global final_freq,e, change_count,ACK_string,pd
    ...
    def main_loop(self):
        ...
        while 1 :
            ...
            global e,t,bsyn,bsynack,oldfreq,pd
            ...
            if (self.tb.sense_busy(self.tb.sink._freq)):
                ...
                while not e.isSet():
                    ...
                    self.tb.send_pkt(payload)
                    print "Tx:TX len(payload) = %4d 33" % (len(payload),)
                    bsyn +=1
                    time.sleep(0.8)
                    if not e.isSet():
                        self.tb.sink._freq = self.tb.set_freq_sink(final_freq)
...
def main():
    global e,y, change_count,bsyn,e1,bsynack,oldfreq,pd
    change_count = 0
    bsyn=0
    bsynack=0
    payload=0
